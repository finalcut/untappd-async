...
$redirectUri = 'http://www.jaisenmathai.com/Untappd-async/simpleTest.php';
$userId = '5763863';
$fsObj = new EpiUntappd($clientId, $clientSecret, $accessToken);
$fsObjUnAuth = new EpiUntappd($clientId, $clientSecret);
?>
