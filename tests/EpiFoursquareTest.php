...
require_once '../EpiUntappd.php';
require_once 'PHPUnit/Framework.php';

class EpiUntappdTest extends PHPUnit_Framework_TestCase
{
...
';
  ...
  function setUp()
  {
    ...
    $this->fsObj = new EpiUntappd($this->clientId, $this->clientSecret, $this->accessToken);
    $this->fsObjUnAuth = new EpiUntappd($this->clientId, $this->clientSecret);
  }

  function testGetAuthorizeurl()
  {
    $aUrl = $this->fsObjUnAuth->getAuthorizeUrl($this->redirectUrl);
    $this->assertEquals($aUrl, 'https://Untappd.com/oauth2/authenticate?client_id=a40b1aece83e8d94a08fff1e94f87c2f04af2881a&response_type=code&redirect_uri=http%3A%2F%2Fmac.fa.com%2Fcallback.php', 'Authorize url did not match');
  }
